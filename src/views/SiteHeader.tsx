...
const Logo = () => (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100" viewBox="0 0 211.2 130.1" style={{ fontSize: "16px", backgroundColor: "white", textRendering: "optimizeLegibility" }}>
        <g>
