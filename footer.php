			...
			<div class="supporters">
				...
				<div style="display: flex; align-items: center; justify-content: center; padding-left: 4%;">
					<div style="max-width: 45%; margin-right: 10px;">
						<a class="oms-logo" href="http://www.oxfordmartin.ox.ac.uk/"><img style="max-height: 180px;" src="/wp-content/themes/owid-theme/images/oxford-martin-school.png" alt="Oxford Martin School logo"></a>
					</div>
